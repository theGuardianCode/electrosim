...
while running:
    ...
    for event in pg.event.get():
        ...
        if event.type == pg.MOUSEBUTTONDOWN:
            if pg.mouse.get_pressed()[0]:
                ...
                particles.append(Particle(pg.Vector2(mouse_pos[0], mouse_pos[1]), default_radius, charges[charge_index], moveable))
    ...
    # Draw text to indicate if placed particles will be moveable
    if moveable == False:
        text = font.render("Fixed", False, (255, 255, 255))
        window.blit(text, (0, 35))
